...
def form_dollar_input(
    ...
    return rx.vstack(
        ...
        rx.hstack(
            rx.text("$", size="2", background_color="lightgrey", line_height="2.5em", min_width="2em", text_align="center", border_radius="5px"),
            rx.input(
                name=name,
                placeholder=placeholder,
                type="int",
            ...
            rx.text(".00", size="2", background_color="lightgrey", line_height="2.5em", min_width="2em", text_align="center", border_radius="5px"),
            width="100%",
            align_items="center",
        ),
        rx.box(height="1px"),
